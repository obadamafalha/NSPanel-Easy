...
1. On the GitHub repository, click on your chosen version name on the [NSPanel Easy Tags](https://github.com/edwardtfn/NSPanel-Easy/tags) list, then select the tab **Code**.
